                    ...
                    <div class="certifications-grid">
                        ...
                        <div class="certification-card" data-aos="flip-left" data-aos-delay="100">
                            ...
                            <div class="certification-footer">
                                <div class="certification-status">
                                    <i class="fas fa-check-circle"></i>
                                    Attestation de stage de Licence 3
                                </div>
                                <a href="https://drive.google.com/file/d/EXEMPLE_ID_3/view" target="_blank"
                                    rel="noopener noreferrer" class="btn-certificate">
                                    <i class="fas fa-external-link-alt"></i>
                                    Voir l'attestation
                                </a>
            ...
            <div class="container">
                ...
                <div class="grid grid-2">
                    ...
                    <!-- <div class="project-card" data-aos="zoom-in" data-aos-delay="100">
                        <div class="project-header">
                            <h3 class="project-title">App Mobile E-commerce</h3>
                        </div>
                        <p class="project-description">
                            Application mobile de commerce électronique développée avec Flutter.
                            Catalogue produits, panier, paiement intégré et suivi des commandes.
                        </p>
                        <div class="tech-stack">
                        ...
                        <div class="project-links">
                            <a href="https://exemple.com/portfolio" target="_blank" class="btn-project">
                                <i class="fas fa-external-link-alt"></i> Voir en ligne
                            </a>
                            <a href="https://github.com/ton-profil/portfolio" target="_blank" class="btn-project">
                                <i class="fab fa-github"></i> Voir le code
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="project-card" data-aos="zoom-in" data-aos-delay="200">
                        <div class="project-header">
                            <h3 class="project-title">Site Web d'Entreprise</h3>
                        </div>
                        <p class="project-description">
                            Site vitrine professionnel pour une entreprise locale. Design moderne,
                            optimisé SEO, formulaires de contact et section blog dynamique.
                        </p>
                        <div class="tech-stack">
                            <span class="tech-tag">HTML5</span>
                            <span class="tech-tag">CSS3</span>
